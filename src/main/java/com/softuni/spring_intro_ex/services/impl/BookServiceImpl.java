...
import com.softuni.spring_intro_ex.entities.*;
import com.softuni.spring_intro_ex.repos.BookRepo;
...
import static com.softuni.spring_intro_ex.constants.GlobalConstants.BOOKS_FILE_PATH;
...
public class BookServiceImpl implements BookService {
    ...
    public List<Book> getAllBooksAfter2000() {
        ...
        LocalDate releaseDate = LocalDate.parse("31/12/2000",dateTimeFormatter);
            return this.bookRepo.getAllByReleaseDateAfter(releaseDate);
    }
